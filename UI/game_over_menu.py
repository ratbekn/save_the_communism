...
class GameOverMenu(Window):
    def __init__(self, event_handler, game):
        ...
        self.start_button = Button(400, 580, 445, 130, pygame.Color('blue'), "restart", event_handler)
        self.quit_button = Button(460, 330, 300, 50, pygame.Color('black'), "Quit", event_handler)
